package com.cqut.faymong.simpleqq.ui.fragment;
...
public class MainFragment extends SupportFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        SupportFragment firstFragment = findChildFragment(QQFirstFragment.class);
    ...
    private void initView(View view) {
        ...
        mBottomBar
                .addItem(new BottomBarTab(_mActivity, R.drawable.bottombar_message, getString(R.string.msg)))
                .addItem(new BottomBarTab(_mActivity, R.drawable.bottombar_contacts, getString(R.string.discover)))
                .addItem(new BottomBarTab(_mActivity, R.drawable.bottombar_dynamic, getString(R.string.more)));
